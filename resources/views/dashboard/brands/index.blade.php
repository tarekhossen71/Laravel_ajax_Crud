...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('brand.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add Brand</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('brand.edit', $item->id) }}" class="btn btn-sm btn-info me-1">Edit</a>
                                <form id="delete-form-{{ $item->id }}" action="{{ route('brand.destroy',$item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                </form>
